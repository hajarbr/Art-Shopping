...
<link rel="stylesheet" type="text/css"
	href="<c:url value="http://localhost:8085/shopieasy/resource/css/ProductList.css"/>">
<script src="<c:url value="http://localhost:8085/shopieasy/resource/js/productController.js"/>"></script>
</head>
<body ng-app="myapp">
