			...
			<div class="row">
				...
				<form:form method="post" action="${url}"
					...
					<div class="col-sm-12">
						...
						<div class="form-group">
							 <form:radiobutton path="productCategory" value="Plant Decor"/>Plant Decor
								 <form:radiobutton path="productCategory" value="Abstract "/>Abstract paintings
								 <form:radiobutton path="productCategory" value="Landscape "/>Landscape paintings
								 <form:radiobutton path="productCategory" value="Fantasy "/>Fantasy paintings			
						</div>
